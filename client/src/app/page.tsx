  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        <section className="relative overflow-hidden bg-linear-to-br from-sky-50 via-white to-blue-50 px-6 py-24 sm:py-32">
          <div className="bg-grid-gray-900/[0.04] absolute inset-0 bg-size-[20px_20px]" />
          <div className="relative mx-auto max-w-7xl">
            <div className="text-center">
              ...
              <p className="mx-auto mb-10 max-w-2xl text-lg text-gray-600 sm:text-xl">
                Book appointments with top-rated stylists in seconds. No phone
                calls, no hassle—just beautiful results.
              </p>
            ...
            <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="group relative rounded-2xl border border-gray-200 bg-white p-8 transition-all hover:border-sky-500 hover:shadow-xl">
                ...
                <p className="text-gray-600">
                  See available time slots instantly and book your preferred
                  time without waiting for confirmation calls.
                </p>
              </div>
              ...
              <div className="group relative rounded-2xl border border-gray-200 bg-white p-8 transition-all hover:border-sky-500 hover:shadow-xl">
                ...
                <p className="text-gray-600">
                  Get immediate booking confirmation with all details sent
                  directly to your email and phone.
                </p>
              </div>
              ...
              <div className="group relative rounded-2xl border border-gray-200 bg-white p-8 transition-all hover:border-sky-500 hover:shadow-xl">
                ...
                <p className="text-gray-600">
                  Pay securely online or choose to pay at the salon. Multiple
              ...
              <div className="group relative rounded-2xl border border-gray-200 bg-white p-8 transition-all hover:border-sky-500 hover:shadow-xl">
                ...
                <p className="text-gray-600">
                  Plans changed? Reschedule or cancel appointments easily
                  through your dashboard with just a few taps.
                </p>
              </div>
              ...
              <div className="group relative rounded-2xl border border-gray-200 bg-white p-8 transition-all hover:border-sky-500 hover:shadow-xl">
                ...
                <p className="text-gray-600">
                  ...
                  reminders sent before your booking.
                </p>
              </div>
              ...
              <div className="group relative rounded-2xl border border-gray-200 bg-white p-8 transition-all hover:border-sky-500 hover:shadow-xl">
                ...
                <p className="text-gray-600">
                  Access your complete booking history and favorite services for
                  quick rebooking anytime.
                </p>
              </div>
            </div>
          </div>
        ...
        {/* CTA Section */}
        <section className="bg-linear-to-br from-sky-600 to-blue-700 px-6 py-24">
